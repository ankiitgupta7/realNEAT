...
def run_experiment(name, data_func, data_range=(-1,1), pop_size=20, generations=10, epochs=200):
    ...
    trained_params = train_model(best_genome, X_train, y_train, epochs=epochs)
    update_genome_weights(best_genome, trained_params)
    ...
    final_acc = evaluate_model(trained_params, best_genome, X_test, y_test)
